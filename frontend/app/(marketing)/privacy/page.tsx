  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose lg:prose-xl">
        ...
        <p>Welcome to Fastcase. We respect your privacy and are committed to protecting your personal data.</p>
        ...
        <h2>4. Contact Us</h2>
        <p>If you have any privacy concerns, contact our Grievance Officer at privacy@Fastcase.in.</p>
      </div>
    </div>
  );
}
