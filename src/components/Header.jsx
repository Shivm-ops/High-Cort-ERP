      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[68px]">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/contact" className="hidden sm:inline-flex btn-secondary text-[14px] py-2 px-4 rounded-lg">
              Book Demo
            </Link>
        ...
        <div className="lg:hidden border-t border-line bg-white overflow-y-auto max-h-[80vh]">
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-3 border-t border-line space-y-2">
              <Link to="/contact" className="btn-secondary w-full rounded-xl">Book Demo</Link>
